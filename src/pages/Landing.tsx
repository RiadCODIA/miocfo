...
const plans = [
  {
    ...
    priceYearly: 41,
    popular: false,
    features: ["Dashboard con KPI finanziari", "Flussi di Cassa", "Transazioni con categorizzazione", "Conti correnti (solo upload)"],
    notIncluded: ["Connessione Home Banking API", "Conto Economico", "Fatture e Scadenzario", "Budget & Previsioni", "AI Assistant"],
  ...
  },
  {
    ...
    features: ["Connessione Home Banking API", "Collegamenti (solo Conti Bancari)", "Sincronizzazione automatica"],
  ...
  },
  {
    ...
    features: ["Conto Economico completo", "Gestione Fatture", "Scadenzario", "Collegamenti completi (Banche + Cassetto Fiscale)"],
  ...
  },
  {
    ...
    features: ["Budget & Previsioni avanzate", "AI Assistant integrato", "Analisi e report con AI", "Dati & Statistiche avanzate", "Notifiche intelligenti"],
    notIncluded: [],
    cta: "Inizia con Full",
  },
];

const allInclude = ["Connessione sicura PSD2", "Crittografia end-to-end", "Aggiornamenti automatici", "Nessun costo nascosto"];
