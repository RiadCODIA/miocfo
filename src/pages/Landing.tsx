...
const plans = [
  {
    ...
    priceYearly: 41,
    popular: false,
    features: ["Dashboard con KPI finanziari", "Flussi di Cassa", "Transazioni con categorizzazione", "Conti correnti (upload + API)", "Connessione Home Banking PSD2", "Crediti AI: €5/mese inclusi"],
  ...
  },
  {
    ...
    features: ["Conto Economico completo", "Gestione Fatture", "Scadenzario", "Collegamenti completi (Banche + Cassetto Fiscale)", "Crediti AI: €8/mese inclusi"],
  ...
  },
  {
    ...
    features: ["Budget & Previsioni avanzate", "AI Assistant integrato", "Analisi e report con AI", "KPI Report avanzati", "Alert e Notifiche intelligenti", "Crediti AI: €20/mese inclusi"],
    notIncluded: [],
    cta: "Inizia con Full",
  },
];
